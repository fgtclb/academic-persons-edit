...
set or through the page field :guilabel:`Page TSconfig`. On TYPO3 v12 the page
field is the only one of the two that works, and that same file also carries the
entry of the new content element wizard, which v12 builds from page TSconfig
rather than from TCA.
